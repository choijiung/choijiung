...
#cler 줄
btn_cler = Button(root, text="cler", width=5, height=2)
btn_equal = Button(root, text="=", width=5, height=2)
btn_div = Button(root, text="/", width=5, height=2)
btn_mul = Button(root, text="*", width=5, height=2)

btn_cler.grid(row = 1, column=0, sticky=N+E+W+S, padx=3, pady=3)
...
btn_ent = Button(root, text="enter", width=5, height=2) #세로로 합쳐짐
...
btn_pt = Button(root, text=".", width=5, height=2)

btn_0.grid(row = 5, column=0, columnspan=2, sticky=N+E+W+S, padx=3, pady=3)
btn_pt.grid(row = 5, column=2, sticky=N+E+W+S, padx=3, pady=3)
